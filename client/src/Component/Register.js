...
import { Link, Outlet, Form, useActionData } from "react-router-dom";
  ...
  return (
    <div className="register--wrapper">
      ...
      <Form method="post" className="register--form" replace>
        ...
        />
        <button
          className="register--form--elements register--form--submit--button"
          type="submit"
        >
          Register
        </button>
        {actionData && (
          <p className="register--form--elements">
